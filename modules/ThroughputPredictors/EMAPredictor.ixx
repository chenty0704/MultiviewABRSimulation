...
public:
    ...
    void Update(double downloadedMB, double downloadSeconds) override {
        ...
        _slowPredictionMbps = _slowPredictionMbps * prevSlowWeight + throughputMbps * (1 - prevSlowWeight);
        _fastPredictionMbps = _fastPredictionMbps * prevFastWeight + throughputMbps * (1 - prevFastWeight);
    }
